...
export class RegistrationService {
  ...
  registerNewUser(user_data: any): Observable<Registration[]>{
      return this.http.post<Registration[]>(this.url+'/register',user_data)

    }
    sendNotificationAfterCreatingAnAccount(user_name,fname,lname): Observable<Registration[]>{
      return this.http.post<Registration[]>(this.url+'/notificationfortrialregister?email='+user_name+'&fname='+fname+'&lname='+lname,'')
    }
}
