...
import { BidRounds } from 'src/app/model/bid-round/bidRounds';
@Injectable({
  providedIn: 'root'
})
export class BidRoundsService {
  ...
  getBidRounds(bidScheduleId): Observable<BidRounds[]>{
    return this.http.get<BidRounds[]>(this.url+'/bidparamroundgetbybidscheduleid/'+bidScheduleId)
  }
