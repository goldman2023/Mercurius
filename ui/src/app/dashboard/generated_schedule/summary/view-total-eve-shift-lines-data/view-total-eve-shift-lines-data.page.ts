    ...
    this.satdAy.push({"shiftName":this.scheduleShift[i].Satshift2.split('-')[0],"shiftDefintion":this.convertRDOtoShiftDefintion(this.scheduleShift[i].Satshift2,this.scheduleShift[i].shiftdurationc),"shift_duration":this.getShiftDuration(this.scheduleShift[i].Satshift2,this.scheduleShift[i].shiftdurationc),"shiftCategory":this.getShiftCategory(this.scheduleShift[i].Satshift2,this.scheduleShift[i].shiftdurationc)})
        ...
        for(var i=0;i<this.allShiftData.length;i++){
          if(this.allShiftData[i].shiftCategory==2){
            for(var j=0;j<countsCustomizedSunDay.length;j++){
              if(Number(this.allShiftData[i].startTime)===Number(countsCustomizedSunDay[j].shiftDefintion) && this.allShiftData[i].shiftCategory==2&& Number(this.allShiftData[i].shift_duration)===Number(countsCustomizedSunDay[j].shift_duration)){
              this.reqvsgenDataShiftTime.push({"sd":String(this.allShiftData[i].startTime),"sdu":this.allShiftData[i].shift_duration})
              }
            }
          for(var j=0;j<countsCustomizedSunDay.length;j++){
            if(this.allShiftData[i].startTime===countsCustomizedSunDay[j].shiftDefintion && this.allShiftData[i].shiftCategory==2&& Number(this.allShiftData[i].shift_duration)===Number(countsCustomizedSunDay[j].shift_duration)){
          ...
          for(var j=0;j<countsCustomizedMonDay.length;j++){
            if(this.allShiftData[i].startTime===countsCustomizedMonDay[j].shiftDefintion && this.allShiftData[i].shiftCategory==2&& Number(this.allShiftData[i].shift_duration)===Number(countsCustomizedMonDay[j].shift_duration)){
          ...
          for(var j=0;j<countsCustomizedTueDay.length;j++){
            if(this.allShiftData[i].startTime===countsCustomizedTueDay[j].shiftDefintion && this.allShiftData[i].shiftCategory==2&& Number(this.allShiftData[i].shift_duration)===Number(countsCustomizedTueDay[j].shift_duration)){
          ...
          for(var j=0;j<countsCustomizedWedDay.length;j++){
            if(this.allShiftData[i].startTime===countsCustomizedWedDay[j].shiftDefintion && this.allShiftData[i].shiftCategory==2&& Number(this.allShiftData[i].shift_duration)===Number(countsCustomizedWedDay[j].shift_duration)){
          ...
          for(var j=0;j<countsCustomizedThuDay.length;j++){
            if(this.allShiftData[i].startTime===countsCustomizedThuDay[j].shiftDefintion && this.allShiftData[i].shiftCategory==2&& Number(this.allShiftData[i].shift_duration)===Number(countsCustomizedThuDay[j].shift_duration)){
          ...
          for(var j=0;j<countsCustomizedFriDay.length;j++){
            if(this.allShiftData[i].startTime===countsCustomizedFriDay[j].shiftDefintion && this.allShiftData[i].shiftCategory==2&& Number(this.allShiftData[i].shift_duration)===Number(countsCustomizedFriDay[j].shift_duration)){
          ...
          for(var j=0;j<countsCustomizedSatDay.length;j++){
            if(this.allShiftData[i].startTime===countsCustomizedSatDay[j].shiftDefintion && this.allShiftData[i].shiftCategory==2&& Number(this.allShiftData[i].shift_duration)===Number(countsCustomizedSatDay[j].shift_duration)){
              if(Number(countsCustomizedFriDay[j].shift_duration)!=Number(this.currentShiftlineScheduleShiftDuration)){
      ...
      for(var k=0;k<this.reqvsgenDataShiftTime.length;k++){
            this.dayData={
              ...
              "diff":{
                "sun":this.diffDay_13_sun=this.reqvsgenDataSun[k].G+ - +this.reqvsgenDataSun[k].R,
                  "mon":this.diffDay_13_mon=this.reqvsgenDataMon[k].G+ - +this.reqvsgenDataMon[k].R,
                  "tue":this.diffDay_13_tue=this.reqvsgenDataTue[k].G+ - +this.reqvsgenDataTue[k].R,
                  "wed":this.diffDay_13_wed=this.reqvsgenDataWed[k].G+ - +this.reqvsgenDataWed[k].R,
                  "thu":this.diffDay_13_thu=this.reqvsgenDataThu[k].G+ - +this.reqvsgenDataThu[k].R,
                  "fri":this.diffDay_13_fri=this.reqvsgenDataFri[k].G+ - +this.reqvsgenDataFri[k].R,
                  "sat":this.diffDay_13_sat=this.reqvsgenDataSat[k].G+ - +this.reqvsgenDataSat[k].R,
              }
        }
