...
export class EditShiftLineScheduleComponent implements OnInit {
  ...
  constructor(private route:Router,
      ...
      this.editScheduleDataForm = new FormGroup({
        id:new FormControl,
        Mon: new FormControl,
        Tue:new FormControl,
        Wed:new FormControl,
...
nextValidation(){
  ...
  this.finalResultShiftLine=[]
        ...
        for(var i=0;i<this.scheduleShiftLine.length;i++)
          {
            if(this.scheduleShiftLine[i]?.seq_id!=ob.seq_id)
            {
              ...
              this.localData.setItem('editCustomizedScheduleShiftLine',JSON.stringify(this.finalResultShiftLine))
          this.localData.setItem('hideBLrulesLabels',JSON.stringify({"hideBLrulesLabels":true}))
          this.localData.setItem('focusShiftLineEdit',JSON.stringify(this.scheduleData.seq_id))
    ...
    buttons: [
      ...
      this.localData.setItem('deletedShiftLines',JSON.stringify(this.deletedShiftLines))
