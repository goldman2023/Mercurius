...
@Entity
@Table(name = "employee_basic_watch_schedule")
public class EmployeeBasicWatchSchedule {
	...
	public EmployeeBasicWatchSchedule() {
		super();
	}
	...
	public EmployeeBasicWatchSchedule(long id, Long bidscheduleid, Long managerid, Long empid, String empinitials,
	...
	public String toString() {
		return "EmployeeBasicWatchSchedule [id=" + id + ", bidscheduleid=" + bidscheduleid + ", managerid=" + managerid
