...
@Service
public class TrialEmailRegistrationServiceImpl implements TrialEmailRegistrationService{
	...
	@Override
	public List<Object> sendTrialEmail(String fname, String lname,String email, String siteURL)
		...
		String firstname= StringUtils.capitalize(fname);
		System.out.println(firstname);
		String lastname = StringUtils.capitalize(lname);
		...
		String content =
				...
				+"<table border='0' align='left' cellpadding='5' cellspacing='0' class='button_block' role='presentation' style='mso-table-lspace: 0pt; mso-table-rspace: 0pt;' width='100%'><tr><td><div style='text-align: left; font-size:15px'>Welcome "+firstname+" "+lastname+",<br><br>Thank you for registering with us. Your Trial Account will be valid for <i>3 days</i>. To know more about how to access StraightLines kindly read the below instructions.<br><span style='color:#000000'>"
				+ "<p><b><i>To begin using StraightLines...</i></b></p>\r\n"
				+ "\r\n"
				+ "<p style='color:blue;'><b>Mobile Phone</b></p>\r\n"
				//+ "\r\n"
				+ "<p>In a browser on your mobile phone, go to <a href='"+verifyURL+"'>StraightLines.io.</a></p>"
				...
				+ " <ol>"
				+ "  <li>In a browser on your computer, go to <a href='"+verifyURL+"'>StraightLines.io.</a></li>\r\n"
